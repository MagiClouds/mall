...
type OrderClient interface {
	...
	UpdateOrderPayStatus(ctx context.Context, in *UpdateOrderPayStatusRequest, opts ...grpc.CallOption) (*UpdateOrderPayStatusReply, error)
	UpdateOrderShipStatus(ctx context.Context, in *UpdateOrderShipStatusRequest, opts ...grpc.CallOption) (*UpdateOrderShipStatusReply, error)
}
...
func (c *orderClient) UpdateOrderPayStatus(ctx context.Context, in *UpdateOrderPayStatusRequest, opts ...grpc.CallOption) (*UpdateOrderPayStatusReply, error) {
	out := new(UpdateOrderPayStatusReply)
	err := c.cc.Invoke(ctx, "/api.order.service.v1.Order/UpdateOrderPayStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderClient) UpdateOrderShipStatus(ctx context.Context, in *UpdateOrderShipStatusRequest, opts ...grpc.CallOption) (*UpdateOrderShipStatusReply, error) {
	out := new(UpdateOrderShipStatusReply)
	err := c.cc.Invoke(ctx, "/api.order.service.v1.Order/UpdateOrderShipStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServer interface {
	...
	UpdateOrderPayStatus(context.Context, *UpdateOrderPayStatusRequest) (*UpdateOrderPayStatusReply, error)
	UpdateOrderShipStatus(context.Context, *UpdateOrderShipStatusRequest) (*UpdateOrderShipStatusReply, error)
...
func (UnimplementedOrderServer) UpdateOrderPayStatus(context.Context, *UpdateOrderPayStatusRequest) (*UpdateOrderPayStatusReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateOrderPayStatus not implemented")
}
func (UnimplementedOrderServer) UpdateOrderShipStatus(context.Context, *UpdateOrderShipStatusRequest) (*UpdateOrderShipStatusReply, error) {
...
func _Order_UpdateOrderPayStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateOrderPayStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServer).UpdateOrderPayStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.order.service.v1.Order/UpdateOrderPayStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServer).UpdateOrderPayStatus(ctx, req.(*UpdateOrderPayStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Order_UpdateOrderShipStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateOrderShipStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServer).UpdateOrderShipStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.order.service.v1.Order/UpdateOrderShipStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServer).UpdateOrderShipStatus(ctx, req.(*UpdateOrderShipStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Order_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateOrderPayStatus",
			Handler:    _Order_UpdateOrderPayStatus_Handler,
		},
		{
			MethodName: "UpdateOrderShipStatus",
			Handler:    _Order_UpdateOrderShipStatus_Handler,
		},
	},
